...
namespace Tumultu.Infrastructure.DataProviders.EFCore.Common;

internal class EfCoreRepositoryBase<TEntity, TId> : IReadOnlyRepository<TEntity, TId>, IRepository<TEntity, TId> where TEntity : BaseEntity<TId>
{
